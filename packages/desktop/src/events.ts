 ...
 */
export const SPOTLIGHT_OPEN_EVENT = "benos:spotlight-open";
 ...
 */
export const NOTIFICATION_CENTER_TOGGLE_EVENT = "benos:notification-center-toggle";
 ...
 */
export const QUICK_SETTINGS_TOGGLE_EVENT = "benos:quick-settings-toggle";
 ...
 */
export const MISSION_CONTROL_TOGGLE_EVENT = "benos:mission-control-toggle";
 ...
 */
export const KEYBOARD_HELP_TOGGLE_EVENT = "benos:keyboard-help-toggle";
 ...
 */
export const APP_SWITCHER_CYCLE_EVENT = "benos:app-switcher-cycle";
