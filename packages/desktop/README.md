...
The BenOS components. One tag renders a working desktop: wallpaper,
menu bar, dock, draggable windows, launcher, settings, notifications.

```tsx
import type { App } from "@benos/core";
import { Desktop } from "@benos/desktop";
import { macosTheme } from "@benos/theme-macos";
...
`react`, `react-dom`, and `@benos/core`. Core is a peer rather than a
...
Docs: https://saschb2b.github.io/BenOS
